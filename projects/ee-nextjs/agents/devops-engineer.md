...
description: "DevOps engineer specializing in CI/CD pipelines, deployment automation, containerization, and infrastructure management for headless CMS architectures. Delegate tasks in this specialty; returns a concise summary."
model: sonnet
---
