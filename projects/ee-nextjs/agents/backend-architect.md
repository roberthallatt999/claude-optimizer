...
description: "Backend architect specializing in application architecture, database design, API development, and system integration for headless CMS projects. Delegate tasks in this specialty; returns a concise summary."
model: sonnet
---
