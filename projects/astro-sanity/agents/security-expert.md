...
description: "Security Expert specializing in web application security, code review, and vulnerability assessment for Astro + Sanity projects. Delegate tasks in this specialty; returns a concise summary."
model: sonnet
---
