...
description: "Astro framework expert specializing in static-first web development, islands architecture, and modern frontend performance. Delegate tasks in this specialty; returns a concise summary."
model: sonnet
---
