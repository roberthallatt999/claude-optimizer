...
description: "Code Quality Specialist focused on clean, maintainable TypeScript code for Astro + Strapi projects. Delegate tasks in this specialty; returns a concise summary."
model: sonnet
---
