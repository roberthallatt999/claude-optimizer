...
description: "DevOps engineer specializing in CI/CD pipelines, deployment automation, and infrastructure management for Astro + Strapi projects. Delegate tasks in this specialty; returns a concise summary."
model: sonnet
---
